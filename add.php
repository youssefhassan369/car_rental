	...
	<body class="modal-body">
		<div>
			<form action="delete.php" method="post">
				<br><br><br>
				<h2 style="color:white; text-align:center">Add car</h2>
...
<label style="width:20%;font-size:20;color:black;margin-left:20%" class="form-control-plaintext">Color:</label>
 <input required style="width:25%;font-size:20;color:black;margin-left:20%" class="form-control" name='color'  id="color">
...
<label style="width:20%;font-size:20;color:black;margin-left:20%" class="form-control-plaintext" >Select Car Transmission:</label>
					<select required style="width:25%;font-size:20;color:black;margin-left:20%"type='text' class="form-control" n name="transsmision" id="transmission">
...
<input required style="width:25%;font-size:20;color:black;margin-left:20%"type='text' class="form-control" name='seats'id="seats"/><br>
...
<input style="color:white;background-color:red;border: none;font-size:20;margin-left:30%" class="btn btn-primary btn-lg" id=submit type="submit" name="submit" value="ADD CAR!"> <br></br>
</div>
