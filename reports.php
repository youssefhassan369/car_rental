  ...
  <div class="container-fluid">
	...
	<body class="modal-body">
        ...
        <div style="background:white;opacity:65% " >
          ...
          <a style="color:black" href="carcustomer.php" class="ca">SearchCar&Customer 'AllInfo'</a><br>
          <a style="color:black" href="car.php" class="ca">SearchCar 'AllInfo'</a><br>
          <a style="color:black" href="carstate.php" class="ca">SearchCarSTATE</a><br>
          <a style="color:black" href="bycustomer.php" class="ca">SearchThroughACustomer 'AllInfo+CarsInfo'</a><br>
          <a style="color:black" href="dailypayments.php" class="ca">DailyPayments</a><br>
         </h2>
