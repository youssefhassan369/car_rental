				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					...
					<a class="navbar-brand" href="#">
						...
						<li class="nav-item active">
							<a style="color:black"class="nav-link" href="search_desgin.php">FOR BOOKING </a>
						</li>
						<li class="nav-item active">
	...
	<h2 style="color:white">Search</h2>
		<br><br>
			...
			<input  style="padding: 4px; width: 160px;" type="date" id="REnd_date" name="REnd_date">
   			...
   			<br></br>
		<label>Select City you want to rent car in:</label>
		...
		<label style="font-size:150% ">Select Car Transmission:</label>
		...
		<label>Select Car Type:</label>
														<select name="type" id="type">
															...
															<option  class="ca" value="CrossOver">Cross Over</option>
															<option class="ca" value="Pickup">Pick up</option>
		...
		<br></br>
			...
			<button type="submit"  class="btn btn-success" value='search' >Search</button>
						...
						<a style="color:black" href="options.php" class="ca">Back</a>
					</div>
			</form>
		</div>
	</body>
